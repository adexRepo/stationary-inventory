package com.project.dex.stationaryinventory.common.jfxsupport;
...
public class AbstractStationaryInventory extends Application {
    private static Logger LOGGER = LoggerFactory.getLogger(AbstractStationaryInventory.class);
	...
	public void start(final Stage stage) throws Exception {
		...
		if (AbstractStationaryInventory.splashScreen.visible()) {
	...
	private void launchApplicationView(final ConfigurableApplicationContext ctx) {
		AbstractStationaryInventory.applicationContext = ctx;
	 ...
	 *            the args
	 */
	public static void launchApp(final Class<? extends AbstractStationaryInventory> appClass,
	...
	public static void launchApp(final Class<? extends AbstractStationaryInventory> appClass,
		...
		if (splashScreen != null) {
			AbstractStationaryInventory.splashScreen = splashScreen;
		} else {
			AbstractStationaryInventory.splashScreen = new SplashScreen();
		}
